...
from kb_genetree.kb_genetreeImpl import kb_genetree  # noqa @IgnorePep8
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_kb_genetree.run_genetree_genome_context,
                             name='kb_genetree.run_genetree_genome_context',
                             types=[dict])
        self.method_authentication['kb_genetree.run_genetree_genome_context'] = 'required'  # noqa
